...
class RealtimeVisualization():
    ...
    def isValid(self, bodyPart):
        ...
        '''
        return bodyPart.score > 0.2 and not math.isnan(bodyPart.point.x) and not math.isnan(bodyPart.point.y) and not math.isnan(bodyPart.point.z) and bodyPart.point.z > 0
    ...
    def frame_callback(self, data):
        ...
        for person in data.persons:
            ...
            for pair in common.CocoPairsRender:
