...
# python3 /home/trainerai/trainerai-core/src/AI/object_detection/yolov5/export.py --weights /home/trainerai/trainerai-core/src/AI/object_detection/yolov5m.pt --include engine --batch-size 2 --device 1 --half