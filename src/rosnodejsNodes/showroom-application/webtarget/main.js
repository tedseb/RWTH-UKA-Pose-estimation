...
RendererComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({ type: RendererComponent, selectors: [["app-renderer"]], viewQuery: function RendererComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { currentExercise: "currentExercise" }, decls: 6, vars: 3, consts: [["autoplay", "", "loop", "", "oncanplay", "this.play()", "onloadedmetadata", "this.muted = true", 1, "exercise-video", 3, "currentTime"], ["src", "../../../assets/squatChallenge.webm", "type", "video/webm"], [1, "reference-frame"], ["id", "editorContainer", 1, "div-editor", 2, "background", "transparent"], ["editorContainer", ""]], template: function RendererComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵproperty"]("currentTime", ctx.frame);
