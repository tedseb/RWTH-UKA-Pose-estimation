...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.active_box = QtWidgets.QCheckBox(self.centralwidget)
        self.active_box.setObjectName("active_box")
        self.horizontalLayout.addWidget(self.active_box)
        self.confirm_button = QtWidgets.QPushButton(self.centralwidget)
        self.confirm_button.setMinimumSize(QtCore.QSize(90, 0))
